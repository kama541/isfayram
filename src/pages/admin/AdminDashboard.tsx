  ...
  return (
    <div className="p-10 min-h-screen bg-[#222838] font-sans">
      <div className="max-w-4xl">
        <h1 className="text-3xl font-bold text-white mb-2">Restoranlar</h1>
        <p className="text-slate-400 mb-10 text-[15px]">Tarmoqdagi restoranlarni boshqarish</p>
        ...
        <div className="bg-[#3b4358] rounded-3xl p-8 max-w-[400px] shadow-2xl relative overflow-hidden group hover:bg-[#434b61] transition-colors cursor-pointer">
          ...
          <div className="border-t border-white/10 pt-6">
            <p className="text-slate-400/80 text-sm mb-3">Kontakt ma'lumotlari yo'q</p>
            <div className="flex items-center gap-2 text-[#ff4b4b] text-sm font-medium">
              <Wifi className="w-4 h-4" /> Sinxronizatsiya 26 daqiqa oldin
            </div>
          </div>
        </div>
      </div>
